...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <ul className={`font-heading font-light text-[.9rem] tracking-[.15em] uppercase list-none ${
        menuOpen
      ...
      <Link href="/#event" className="btn-primary hidden md:inline-block">Get Tickets</Link>
